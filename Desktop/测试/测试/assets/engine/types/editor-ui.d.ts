declare namespace gui {
    ...
    class InputManager {
        ...
        getLastPressedKey(timeThreshold?: number): string;
        private onKeydown;
        private onKeyup;
    ...
    interface IScroller {
        ...
        scrollTo(target: Widget, ani?: boolean, setFirst?: boolean): void;
        scrollTo(target: Widget, ani?: boolean, secondTarget?: Widget): void;
        scrollTo(target: Rect, ani?: boolean, setFirst?: boolean): void;
    ...
    class Image extends Widget {
        ...
        get color(): number;
        set color(value: number);
        protected onLoaded(res: Texture, loadID: number): void;
        protected _sizeChanged(changeByLayout?: boolean): void;
    ...
    class Loader extends Widget {
        ...
        protected onLoaded(value: any, loadId: number): void;
    ...
    class TreeNode {
        ...
        getLastVisibleDecendant(): TreeNode;
    ...
    class Widget extends EventDispatcher {
        ...
        private childSortingOrderChanged;
